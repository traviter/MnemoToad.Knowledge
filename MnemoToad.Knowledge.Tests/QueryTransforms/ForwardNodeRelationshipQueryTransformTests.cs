...
[TestFixture]
public class ForwardNodeRelationshipQueryTransformTests
{
    private MockableAppDbContext _db = null!;
    private ForwardNodeRelationshipQueryTransform _transform = null!;

    [SetUp]
    public void SetUp()
    {
        _db = new MockableAppDbContext();
        _transform = new ForwardNodeRelationshipQueryTransform(_db);
    }
